...
The force is just $\vec{F} = -\vec{\nabla}U$, $F_z = -\frac{\partial U}{\partial z}$. $U = -\vec{\mu}\cdot\vec{B}$. For Silver (Ag) $\vec{L} = 0$, so $\vec{S} \neq 0 \to$ single electron, $U = -g_{e}\frac{|e|}{2m_ec}S_zB_z$. $F_z = -\frac{g_e|e|}{2m_ec}\frac{dB_z}{dz}S_z$, $F_z =\frac{g_e|e|}{2m_ec}|\frac{dB_z}{dz}|S_z$, $F_z \prop S_z$.
% ============================================================
%  APPENDIX
% ============================================================
\appendix
