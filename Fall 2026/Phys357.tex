...
%Talk about the experiement how you can filter out beams/atoms and always 50/50 chance and if you make it go through SGz and filter out one spin and put it again in SGz then the same spin will result, but if SGz filter then SGx after itll be 50 |-x> and 50 |+x>, also add an illustration
