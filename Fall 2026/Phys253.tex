...
\begin{remark}
    This lets a system with, say, a temperature gradient still be treated cell by cell: each cell is locally in equilibrium even though the system as a whole is not.
\end{remark}
