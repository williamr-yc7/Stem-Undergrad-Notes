...
\end{proposition}
To verify that the standard basis really is a basis, two conditions must be satisfied: it spans \(\mathbb{R}^n\) and is linearly independent. To prove the standard basis is a basis, please refer to the Appendix \eqref{subsec:SB}.
...
\begin{definition}[Vector space over a field]
    ...
    (see the Appendix \eqref{subsec:VSA} for the complete list).
\end{definition}
