...
\begin{definition}[Magnetic Field]
    A magnetic field $\vec B$ is a vector field that exerts a force on moving electric charges and magnetic dipoles. It is produced by moving charges (currents) and intrinsic magnetic moments of particles. The SI unit of the magnetic field is the tesla (T).
\end{definition}
