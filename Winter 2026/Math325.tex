...
\[y(t) = e^{(\alpha+i\beta)t}(u+iv) = e^{\alpha t} e^{i\beta t}(u+iv) = e^{\alpha t}(\cos(\beta t)+i\sin(\beta t))(u+iv).\]
Multiplying and separating real and imaginary parts gives
\[y(t) = e^{\alpha t}(\cos(\beta t)u-\sin(\beta t)v) + i\,e^{\alpha t}(\sin(\beta t)u+\cos(\beta t)v).\]
Taking real and imaginary parts therefore yields two real solutions:
\[y_1(t)=e^{\alpha t}\big(u\cos(\beta t)-v\sin(\beta t)\big), \qquad y_2(t)=e^{\alpha t}\big(u\sin(\beta t)+v\cos(\beta t)\big).\]
