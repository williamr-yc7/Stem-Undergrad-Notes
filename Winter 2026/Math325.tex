...
\end{theorem}
We first justify the theorem by showing that the set of solutions indeed forms a vector space of dimension \(n\).
\begin{proof}[$S$ is a vector space of dimension \(n\)]
