...
\begin{proof}[Uniqueness]
    ...
    Which implies that \(e^{-L(t-t_0)}g(t)\) is decreasing. Therefore, for all $t \geq t_0, \quad 0 \leq e^{-L(t-t_0)}g(t) \leq e^{-L(t-t_0)}g(t_0)$.
    From that we get $g(t) = 0$. Which implies that $g'(t) = ||y(t) - z(t)|| = 0$ for all $t \in J$.
\end{proof}
\section{}
\section{}
\section{}
