...
\subsubsection{Existence and Uniqueness Theorem}%to organize
...
\begin{solution}[Existence and Uniqueness Theorem]
    \begin{enumerate}
        \item For this IVP, $y' = \sqrt{1 + y^2} + t^2$, the function is simply $f(y,t) = \sqrt{1 + y^2} + t^2$.
        \item 2. Check the hypotheses:
        \begin{itemize}
