...
This project connects to my interest in the high-energy behavior of matter and the conditions of the early universe. I am curious about how the “shape space” of colliding nuclei (from footballs to pear shapes) influences the momentum distribution of particles after collisions, and what this can reveal about the properties of the Quark-Gluon Plasma. My experience with programming in C++, Python, and SQL would allow me to run simulations and explore the effects of varying shape parameters, while learning how theoretical models are applied to real physical systems. I look forward to contributing to the project and gaining hands-on experience in numerical modeling and data analysis.
